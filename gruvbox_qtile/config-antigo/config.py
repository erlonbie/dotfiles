...
myBrowser = "google-chrome-beta" # My terminal of choice
...
groups = [Group("DEV", layout='ratiotile'),
          Group("WWW", layout='ratiotile'),
          Group("SYS", layout='ratiotile'),
          Group("SYS", layout='ratiotile'),
          Group("DOC", layout='ratiotile'),
          Group("VBOX", layout='ratiotile'),
          Group("CHAT", layout='ratiotile'),
          Group("MUS", layout='ratiotile'),
          Group("VID", layout='ratiotile'),
